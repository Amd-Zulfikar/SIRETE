                ...
                <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <input name="name" type="text" value="{{ $role->name }}" class="form-control" placeholder="Masukan Nama Role" required>
                      ...
                      <input name="keterangan" type="text" value="{{ $role->keterangan }}" class="form-control"  placeholder="Masukan Keterangan" required>
