...
<head>
  ...
  <title>@yield('title', 'Sirete App')</title>
  ...
  <aside class="main-sidebar main-sidebar-custom sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="javascript:void(0)" class="d-block">{{ Auth::user()->name}} | {{ Auth::user()->role}}</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ route ('index.employee')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pegawai</p>
                </a>
              </li>
    ...
    <div class="sidebar-custom">
      ...
      <a href="#" class="btn btn-secondary hide-on-collapse pos-right" onclick="event.preventDefault(); document.getElementById('logout-form-admin').submit();">logout</a>
    </div>
