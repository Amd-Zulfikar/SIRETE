                ...
                <div class="card-body">
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <input name="name" type="text" class="form-control" placeholder="Masukan Nama Pegawai" required>
                      ...
                      <input name="contact" type="text" class="form-control"  placeholder="Masukan contact" required>
